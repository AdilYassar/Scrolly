const Colors = {
  ...
  iconNotification: '#FF6B6B', // Notification icon badge color
  tabBarActive: '#4DB6AC', // Active tab icon color
  tabBarInactive: '#B0BEC5', // Inactive tab icon color
  borderColor: '#E0E0E0', // Replace with border color from the design
};
